...
\item Wir betrachten nun ein weniger offensichtliches Beispiel.  Die Grammatik $G$
      ...
      \\[0.2cm]
      \hspace*{1.3cm}
      $\textsl{a} \rightarrow \quoted{A} \textsl{b} \mid \textsl{a} \quoted{B} \mid \textsl{b}\;\textsl{c}$
      \\[0.2cm]
      \hspace*{1.3cm}
      $\textsl{b} \rightarrow \quoted{A} \textsl{b} \mid \textsl{a} \quoted{B} \mid \textsl{c}\;\textsl{c}$
      \\[0.2cm]
      \hspace*{1.3cm}
