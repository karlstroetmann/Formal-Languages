...
$.
\\[0.2cm]
Diese Grammatik bezeichnen wir als die augmentierte Grammatik.  Die Verwendung der
augmentierten Grammatik vereinfacht die nun folgende Definition des Start-Zustands.
Wir setzen nämlich:
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
ein  Als erstes berechnen wir die Menge der Zustände $Q$.  Wir hatten dafür oben die
...
\begin{array}[t]{lcl}
  s_2 & = & \textsl{goto}(s_1, \squoted{+})  \\
      ...
      & = & \{ E \rightarrow E \quoted{+} \bullet E,\;
               E \rightarrow \bullet E \quoted{+} E,\;
               E \rightarrow \bullet E \quoted{*} E,\;
               E \rightarrow \bullet N\;
            \}\bigr) 
...
\begin{array}[t]{lcl}
  s_3 & = & \textsl{goto}(s_2, E)  \\
      & = & \textsl{closure}\bigl(\{  
               ...
               E \rightarrow E \bullet \quoted{+} E,\;
               E \rightarrow E \bullet \quoted{*} E \}\bigr) \\
      & = & \{ E \rightarrow E \quoted{+} E \bullet,\;
               E \rightarrow E \bullet \quoted{+} E,\;
               E \rightarrow E \bullet \quoted{*} E \;
            \}\bigr) 
...
\[ A \rightarrow \bullet: \quoted{x} \quad \mbox{und} \quad 
   B \rightarrow \bullet: \quoted{y}
\]
...
LALR-Parser.  Bei 
\href{http://www.gnu.org/software/bison/manual/bison.html}{\textsl{Bison}} ist es in der Version 3.0
