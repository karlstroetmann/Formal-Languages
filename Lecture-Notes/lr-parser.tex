...
\\[0.2cm]
zu definieren.  Um dieses Ziel zu erreichen, müssen wir uns als erstes festlegen,
wie die Zustände der Menge $Q$ definieren wollen, denn dann funktioniert die Definition der
...
In diesem Abschnitt definieren wir die beiden Funktionen  \textsl{First} und \textsl{Follow}:
...
\begin{figure}[htbp]
  ...
  \begin{eqnarray*}
  \textsl{conjunction} & \rightarrow & \;\textsl{conjunction} \aquoted{\&} \textsl{disjunction}  \\
                       & \mid        & \;\textsl{disjunction}                                    \\[0.2cm]
  \textsl{disjunction} & \rightarrow & \;\textsl{disjunction} \aquoted{|} \textsl{literal}       \\
                       & \mid        & \;\textsl{literal}                                        \\[0.2cm]
  \textsl{literal}     & \rightarrow & \aquoted{!} \textsc{Identifier}                          \\
...
\begin{Definition}[erweiterte markierte Regel]
  Eine \blue{erweiterte markierte Regel} (abgekürzt: \blue{e.m.R.}) einer Grammatik 
