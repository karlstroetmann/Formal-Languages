...
Die Methode \texttt{stackSize} gibt beim Laden einer Variablen  den Wert $1$ zurück, den es
...
\exerciseEng
Extend the compiler discussed in this chapter so that  \texttt{for}-loops are supported.  The
syntax of these \texttt{for}-loops should be similar to the syntax of \texttt{for}-loops in the
