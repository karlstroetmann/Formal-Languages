...
$\max(s_1, 1 + s_2)$
\\[0.2cm]
and the function \mytt{compile} can be specified as follows:
\[
   \begin{array}[t]{lcccl}
...
\subsubsection{Translation of Inequations}
...
the for \mytt{inot} that negates a logical value.  But there is another way: Since we represent the truth
