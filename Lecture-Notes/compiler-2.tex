...
def compile_expr(expr, st, class_name):
    match expr:
        case str(var):     # variables
            ...
        case 'Number', n:  # numbers
            ...
        case ('+' | '-' | '*' | '/' | '%') as op, lhs, rhs:
            ...
        case 'call', 'println', *args: # println
            ...
        case 'call', f, *args: # user defined functions
            ...
        case _:
            assert False, \
            f'E: compile_expr({expr}, {st}, {class_name})'
\end{minted}
\vspace*{-0.3cm}
...
\item If $f$ is the function \mytt{println}, then \textsl{Jasmin} treats the function $f$ as a method of the
      ...
      Figure \ref{fig:Compiler.ipynb:compile:fct} on page \pageref{fig:Compiler.ipynb:compile:call_println} shows how the
      translation of a call to \texttt{println} is implemented.
   ...
   ...
     case 'call', 'println', *args: # println
           ...
           for arg in args:
               ...
               cnt      += 1
           Is = "I" * cnt
           iv = f'invokevirtual java/io/PrintStream/println({Is})V'
           CmdLst += [iv]
...
\item $f$ is a user defined function.  In this case, the byte code treats $f$ as a static function of the
      ...
      Figure \ref{fig:Compiler.ipynb:compile:fct} on page \pageref{fig:Compiler.ipynb:compile:fct} shows how the
