...
we learn how regular expressions can be implemented using \blue{finite state automatons}\index{finite state automaton},
...
and the non-deterministic ones known as \blue{non-deterministic finite automaton}\index{non-deterministic finite automaton}, abbreviated as
...
\hline
\hline
\texttt{a} & $S_0$ & $S_2$ & $S_4$ & $S_6$ & $S_0$ & $S_2$ & $S_3$ & $S_6$ \\
\hline
\texttt{b} & $S_1$ & $S_3$ & $S_5$ & $S_7$ & $S_1$ & $S_4$ & $S_5$ & $S_7$ \\
\hline
\end{tabular}
\end{center}
