...
\section[From Regular Expression to NFAs]{From Regular Expressions to Non-Deterministic Finite State Automatons}
In this section we show how regular expressions can be implemented as non-deterministic finite state automaton.
...
\section{Conclusion}
In this chapter we have shown that the concept of a \blue{deterministic finite state automaton}
and a \blue{regular expression} are equivalent.
\begin{enumerate}[(a)]
\item Every deterministic finite state automaton can be translated into an equivalent regular expression.
...
\end{enumerate}
Furthermore, we have shown that every deterministic finite state automaton can be minimized.
...
\begin{enumerate}[(a)]
\item How are deterministic and non-deterministic finite state automatons defined?
...
\item How do we mimimize a finite state automaton?
\end{enumerate}
