...
\item Die Zeilen 18 und 19 enthalten die Regeln unseres Scanners.  Eine Regel hat die Form
      ...
      wird.
\item In Zeile 18 spezifiziert der reguläre Ausdruck ``\texttt{0|[1-9][0-9]*}'' eine natürliche Zahl.
...
\item In Zeile 19 spezifiziert der reguläre Ausdruck ``\texttt{.|\symbol{92}R}'' ein beliebiges
