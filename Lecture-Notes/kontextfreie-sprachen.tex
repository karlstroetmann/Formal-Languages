...
Sprachen, die mit Hilfe von \emph{kontextfreien Grammatiken} definiert werden.  Letztere werden wir
nun einführen.
...
\\[0.2cm]
Ein String der Sprache $L(x)$ kann also kein ``\texttt{B}'' enthalten, das zu einem
``\texttt{A}'' gehört, das vor diesem String steht und analog kann 
ein String der Sprache $L(y)$  kein ``\texttt{A}'' enthalten, das zu einem
