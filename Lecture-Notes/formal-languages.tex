...
\hspace*{\fill} 
\\[0.2cm]
The last time I gave this lecture in 2015, I had used \textsl{Java} as the programming language.
Currently, I am switching to using \textsl{Python} instead.  Therefore, these lecture notes are subject to
continuous change.  Provided the program \href{http://git-scm.com/download}{\texttt{git}} 
