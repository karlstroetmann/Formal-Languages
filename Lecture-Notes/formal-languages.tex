...
\begin{minipage}[t]{1.0\linewidth} 
  ...
  \hspace*{\fill} 
  \\[0.2cm]
  The previous time I gave this lecture was in 2015.  Then, I had used \textsl{Java} as the main programming language.
  Currently, I am rewriting all programs using \textsl{Python}.  Until this task is finished, these lecture notes
  are going to change frequently.  Provided the program \href{http://git-scm.com/download}{\texttt{git}} 
