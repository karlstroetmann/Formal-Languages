...
Es sei $\Sigma$ ein Alphabet, $L \subseteq \Sigma^*$ eine formale Sprache und $n\in\mathbb{N}_0$
eine natürliche Zahl.  Wir definieren die \emph{$n$-te Potenz} von $L$, wir schreiben dafür $L^n$, durch
Induktion nach $n$.
\begin{enumerate}
\item[I.A.:] $n = 0$: 
