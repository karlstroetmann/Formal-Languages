...
Interpreter für eine einfache Programmiersprache. 
...
\end{Verbatim}
\vspace*{-0.3cm}
\caption{\textsc{Ebnf}-Grammatik für eine einfache Programmier-Sprache.}
\label{fig:Pure.g4}
\end{figure}
...
Parser ignoriert, stehen aber noch für Fehlermeldungen zur Verfügung.
