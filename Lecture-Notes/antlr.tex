...
\\[0.2cm]
In dieser Vorlesung werden wir die Version 4.4 verwenden.  Das Werkzeug \textsc{Antlr} ist in der
...
\item In den Zeilen 34 und 35 greifen wir auf die Strings, die den Token
      ...
      Variable \texttt{text} zurück.  Beachten Sie, dass wir in Zeile 34 den Wert, der zu einer
