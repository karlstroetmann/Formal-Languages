...
A blue{parser generator} \index{parser generator} is a program that takes a grammar as its input and generates a parser
...
The evaluation of arithmetical was relatively easy as it is possible to evaluate an arithmetical expression
