...
Used as rewrite rules, these laws can simplify regular expressions.  Some of them have to be read from right to
left for this purpose, e.g.~law (m) replaces $\varepsilon + r^* \cdot r$ by $r^*$.  The \textsl{Jupyter}
notebook
\\[0.2cm]
\hspace*{1.3cm}
