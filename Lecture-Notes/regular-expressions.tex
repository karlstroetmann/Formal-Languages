...
the initial success of the programming language \href{http://en.wikipedia.org/wiki/Perl}{\textsl{Perl}} was
largely due to its efficiency in dealing with regular expressions.
Today, all modern high-level languages, e.g.~\textsl{Java}, \texttt{C\#}, and many others
