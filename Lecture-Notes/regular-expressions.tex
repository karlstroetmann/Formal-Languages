...
operator occurs twice.  However, we will see in the next section that the operators ``$+$'' and ``$\cdot$'' are
associative, i.e.~both ways of setting the parentheses yield the same language.  Therefore, we omit these
parentheses.
\\[0.2cm]
\examplesEng
