...
\\[0.2cm]
\hspace*{1.3cm}
\href{https://github.com/karlstroetmann/Formal-Languages/blob/master/Python/Chapter-02/Simplify-RegExp.ipynb}{Python/Chapter-02/Simplify-RegExp.ipynb}
\\[0.2cm]
contains a parser for the regular expressions defined in this chapter and a function \texttt{simplify\_regexp}
that simplifies regular expressions using the laws given above.
\pagebreak
