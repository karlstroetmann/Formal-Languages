...
betrachten weren, ist dies der Fall.  Für die Praxis ist ein LALR(1)-Parser jedoch oft
...
Schlüsselwörter immer erreichen, dass die Sprachen die LALR(1)-Eigenschaft besitzt.
...
\item Der Typ \texttt{FUNC} steht für den Namen einer unären Funktion.
      ...
      Buchstaben beginnt.  Der Scanner trifft die Unterscheidung an Hand einer
...
\item Die Regel in Zeile 12 entfernt Leerzeichen, Tabulatoren und Wagen-Rückläufe.
      ...
      Daher sucht sucht der  Scanner stattdessen das nächste Token.
