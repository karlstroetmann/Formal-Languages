...
\\[0.2cm]
Wir werden in diesem Abschnitt ein Verfahren vorstellen, mit dem wir für zwei reguläre
...
\begin{Theorem}[Pumping-Lemma]
  ...
  \end{enumerate}
  Das Pumping-Lemma für eine reguläre Sprache $L$ kann in einer einzigen Formel zusammengefasst
  werden: 
  \\[0.2cm]
  \hspace*{0.1cm}
...
\proof
Da $L$ eine reguläre Sprache ist, gibt es einen deterministischen endlichen Automaten
\\[0.2cm]
\hspace*{1.3cm}
$A = \langle Q, \Sigma, \delta, q_0, F \rangle$,
\\[0.2cm]
...
\\[0.2cm]
Da wir dieses Spiel beliebig oft wiederholen können, haben wir für alle $h \in \mathbb{N}_0$
\begin{equation}
  \label{eq:pumping4}
...
Syntax gängiger  Programmier-Sprachen adäquat zu beschreiben.  Im nächsten Kapitel werden wir 
das Konzept der kontextfreien Grammatik kennen lernen, das wesentlich mächtiger als das
