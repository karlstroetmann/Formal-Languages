...
\begin{enumerate}
\item \textsc{Ply}      generates a parser for \textsl{Python} programs. \index{Ply}
...
is called a \emph{formal language}. \index{formal language} \qed
\end{Definition}
...
\item What is a \blue{formal language}?
\end{enumerate}
