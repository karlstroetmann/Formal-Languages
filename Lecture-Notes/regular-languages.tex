...
\blue{union}, \blue{intersection} and \blue{complement}.  We start with the union.
...
Proof: While the proof of the last proposition follows directly from the definition of regular expressions,
