...
\item The workhorse of the scanner is the method \textsl{main()} defined in line 17 -- 33.
      ...
      \end{enumerate}
\item Next, the lines 34 and 35 define two \blue{macros}.  A macro is just an abbreviation that can
...
These parts are dealt with by the  \blue{default rule} of \textsl{JFlex}:  Every character of the
...
\item Alternatively, we can use \blue{scanner states}.
