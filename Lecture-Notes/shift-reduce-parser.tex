...
\item The main loop of the parser 
      ...
      \end{itemize}
      What happens then depends on this value of $\textsl{action}(q, t)$.
      \begin{enumerate}
      \item $\textsl{action}(q,t)$ is undefined.

            If $\textsl{action}(q,t)$ is undefined, the parser has found an error
      ...
      \item $\textsl{action}(q,t) = \pair(\texttt{reduce}, A \rightarrow X_1 \cdots X_n)$.
            ...
            In this case we know that the symbols $X_1$, $\cdots$, $X_n$ are on top of the
            ...
            the stack of states in line 27.
