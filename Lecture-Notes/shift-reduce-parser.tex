...
\blue{Shift-Reduce-Parser}.  Ist $G = \langle V, T, R, S \rangle$ eine kontextfreie Grammatik, so
wird ein Shift-Reduce-Parser\index{Shift-Reduce-Parser} $P$ durch ein 4-Tupel
\\[0.2cm]
\hspace*{1.3cm}
...
\begin{enumerate}
\item $Q$ ist die Menge der \blue{Zustände} des Shift-Reduce-Parsers.  
