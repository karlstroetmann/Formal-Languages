// $ANTLR 3.0 simpleLanguage.g 2009-03-19 17:34:44
...
public class simpleLanguageParser extends Parser {
    ...
    // simpleLanguage.g:8:1: simpleLanguage returns [List<Statement> program] : (s= statement )+ ;
    public final List<Statement> simpleLanguage() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:9:7: ( (s= statement )+ )
            // simpleLanguage.g:9:7: (s= statement )+
            {
            if ( backtracking==0 ) {
            ...
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // simpleLanguage.g:10:8: s= statement
            	    {
    ...
    // simpleLanguage.g:18:1: statement returns [Statement stmnt] : (v= VAR ( '=' e= expr ';' | '++;' ) | 'print' '(' r= expr ')' ';' | 'if' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'while' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'for' '(' init= statement ';' b= boolExpr ';' (loop= statement )* ')' '{' (l= statement )* '}' );
    public final Statement statement() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:19:7: (v= VAR ( '=' e= expr ';' | '++;' ) | 'print' '(' r= expr ')' ';' | 'if' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'while' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'for' '(' init= statement ';' b= boolExpr ';' (loop= statement )* ')' '{' (l= statement )* '}' )
            int alt7=5;
            switch ( input.LA(1) ) {
            case VAR:
                {
            ...
            default:
                ...
                NoViableAltException nvae =
                    new NoViableAltException("18:1: statement returns [Statement stmnt] : (v= VAR ( '=' e= expr ';' | '++;' ) | 'print' '(' r= expr ')' ';' | 'if' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'while' '(' b= boolExpr ')' '{' (l= statement )* '}' | 'for' '(' init= statement ';' b= boolExpr ';' (loop= statement )* ')' '{' (l= statement )* '}' );", 7, 0, input);
            ...
            switch (alt7) {
                case 1 :
                    ...
                    if ( (LA2_0==8) ) {
                        ...
                        if (backtracking>0) {failed=true; return stmnt;}
                        NoViableAltException nvae =
                            new NoViableAltException("20:7: ( '=' e= expr ';' | '++;' )", 2, 0, input);

                        throw nvae;
                    }
                    switch (alt2) {
                        case 1 :
                            // simpleLanguage.g:20:8: '=' e= expr ';'
                            {
                    ...
                    break;
                case 2 :
                    // simpleLanguage.g:24:7: 'print' '(' r= expr ')' ';'
                    {
                    ...
                    break;
                case 3 :
                    // simpleLanguage.g:26:7: 'if' '(' b= boolExpr ')' '{' (l= statement )* '}'
                    {
                    if ( backtracking==0 ) {
                    ...
                    // simpleLanguage.g:28:7: (l= statement )*
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // simpleLanguage.g:28:8: l= statement
                    	    {
                    ...
                    break;
                case 4 :
                    // simpleLanguage.g:30:7: 'while' '(' b= boolExpr ')' '{' (l= statement )* '}'
                    {
                    if ( backtracking==0 ) {
                       List<Statement> stmnts = new ArrayList<Statement>(); 
                    }
                    ...
                    // simpleLanguage.g:32:7: (l= statement )*
                    loop4:
                    do {
                        int alt4=2;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // simpleLanguage.g:32:8: l= statement
                    	    {
                    ...
                    break;
                case 5 :
                    // simpleLanguage.g:34:6: 'for' '(' init= statement ';' b= boolExpr ';' (loop= statement )* ')' '{' (l= statement )* '}'
                    {
                    if ( backtracking==0 ) {
                       List<Statement> stmnts = new ArrayList<Statement>(); 
                    ...
                    // simpleLanguage.g:36:56: (loop= statement )*
                    loop5:
                    do {
                        int alt5=2;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // simpleLanguage.g:36:57: loop= statement
                    	    {
                    ...
                    // simpleLanguage.g:37:7: (l= statement )*
                    loop6:
                    do {
                        int alt6=2;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // simpleLanguage.g:37:8: l= statement
                    	    {
    ...
    // simpleLanguage.g:45:1: boolExpr returns [BoolExpr result] : r= conj ( ( '||' q= conj ) )* ;
    public final BoolExpr boolExpr() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:46:7: (r= conj ( ( '||' q= conj ) )* )
            // simpleLanguage.g:46:7: r= conj ( ( '||' q= conj ) )*
            {
            ...
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // simpleLanguage.g:47:9: ( '||' q= conj )
            	    {
            	    // simpleLanguage.g:47:9: ( '||' q= conj )
            	    // simpleLanguage.g:47:10: '||' q= conj
            	    {
    ...
    // $ANTLR start conj
    // simpleLanguage.g:55:1: conj returns [BoolExpr result] : r= neg ( ( '&&' q= neg ) )* ;
    public final BoolExpr conj() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:56:9: (r= neg ( ( '&&' q= neg ) )* )
            // simpleLanguage.g:56:9: r= neg ( ( '&&' q= neg ) )*
            {
            ...
            do {
                ...
                switch (alt9) {
            	case 1 :
            	    // simpleLanguage.g:57:11: ( '&&' q= neg )
            	    {
            	    // simpleLanguage.g:57:11: ( '&&' q= neg )
            	    // simpleLanguage.g:57:12: '&&' q= neg
            	    {
    ...
    // $ANTLR start neg
    // simpleLanguage.g:61:1: neg returns [BoolExpr result] options {backtrack=true; } : ( '!' n= neg | '(' b= boolExpr ')' | s= simpleboolExpr );
    public final BoolExpr neg() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:63:7: ( '!' n= neg | '(' b= boolExpr ')' | s= simpleboolExpr )
            int alt10=3;
            switch ( input.LA(1) ) {
            case 21:
                {
            ...
            case 12:
                ...
                if ( (synpred2()) ) {
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("61:1: neg returns [BoolExpr result] options {backtrack=true; } : ( '!' n= neg | '(' b= boolExpr ')' | s= simpleboolExpr );", 10, 2, input);
            ...
            default:
                if (backtracking>0) {failed=true; return result;}
                NoViableAltException nvae =
                    new NoViableAltException("61:1: neg returns [BoolExpr result] options {backtrack=true; } : ( '!' n= neg | '(' b= boolExpr ')' | s= simpleboolExpr );", 10, 0, input);
            ...
            switch (alt10) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // simpleLanguage.g:64:7: '(' b= boolExpr ')'
                    {
                    ...
                    break;
                case 3 :
                    // simpleLanguage.g:65:7: s= simpleboolExpr
                    {
    ...
    // simpleLanguage.g:71:1: simpleboolExpr returns [BoolExpr result] : l= expr ( '==' r= expr | '<' r= expr ) ;
    public final BoolExpr simpleboolExpr() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:72:7: (l= expr ( '==' r= expr | '<' r= expr ) )
            // simpleLanguage.g:72:7: l= expr ( '==' r= expr | '<' r= expr )
            {
            ...
            _fsp--;
            if (failed) return result;
            // simpleLanguage.g:72:16: ( '==' r= expr | '<' r= expr )
            int alt11=2;
            ...
            if ( (LA11_0==22) ) {
                ...
                if (backtracking>0) {failed=true; return result;}
                NoViableAltException nvae =
                    new NoViableAltException("72:16: ( '==' r= expr | '<' r= expr )", 11, 0, input);

                throw nvae;
            }
            switch (alt11) {
                case 1 :
                    // simpleLanguage.g:72:18: '==' r= expr
                    {
    ...
    // $ANTLR start expr
    // simpleLanguage.g:77:1: expr returns [Expr result] : p= product ( ( '+' q= product ) | ( '-' q= product ) )* ;
    public final Expr expr() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:78:7: (p= product ( ( '+' q= product ) | ( '-' q= product ) )* )
            // simpleLanguage.g:78:7: p= product ( ( '+' q= product ) | ( '-' q= product ) )*
            {
            ...
            // simpleLanguage.g:79:7: ( ( '+' q= product ) | ( '-' q= product ) )*
            loop12:
            do {
                int alt12=3;
                ...
                switch (alt12) {
            	case 1 :
            	    // simpleLanguage.g:79:11: ( '+' q= product )
            	    {
            	    // simpleLanguage.g:79:11: ( '+' q= product )
            	    // simpleLanguage.g:79:12: '+' q= product
            	    {
    ...
    // $ANTLR start product
    // simpleLanguage.g:84:1: product returns [Expr result] : f= factor ( ( '*' g= factor ) | ( '/' g= factor ) )* ;
    public final Expr product() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:85:7: (f= factor ( ( '*' g= factor ) | ( '/' g= factor ) )* )
            // simpleLanguage.g:85:7: f= factor ( ( '*' g= factor ) | ( '/' g= factor ) )*
            {
            ...
            // simpleLanguage.g:86:7: ( ( '*' g= factor ) | ( '/' g= factor ) )*
            loop13:
            do {
                int alt13=3;
                ...
                switch (alt13) {
            	case 1 :
            	    // simpleLanguage.g:87:11: ( '*' g= factor )
            	    {
            	    // simpleLanguage.g:87:11: ( '*' g= factor )
            	    // simpleLanguage.g:87:12: '*' g= factor
            	    {
    ...
    // $ANTLR start factor
    // simpleLanguage.g:92:1: factor returns [Expr result] : ( '(' expr ')' | v= VAR | n= NUMBER );
    public final Expr factor() throws RecognitionException {
        ...
        try {
            // simpleLanguage.g:93:7: ( '(' expr ')' | v= VAR | n= NUMBER )
            int alt14=3;
            switch ( input.LA(1) ) {
            case 12:
                {
            ...
            default:
                if (backtracking>0) {failed=true; return result;}
                NoViableAltException nvae =
                    new NoViableAltException("92:1: factor returns [Expr result] : ( '(' expr ')' | v= VAR | n= NUMBER );", 14, 0, input);
            ...
            switch (alt14) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // simpleLanguage.g:95:7: n= NUMBER
                    {
                    n=(Token)input.LT(1);
    ...
    public final void synpred2_fragment() throws RecognitionException {   
        // simpleLanguage.g:64:7: ( '(' boolExpr ')' )
        // simpleLanguage.g:64:7: '(' boolExpr ')'
        {
