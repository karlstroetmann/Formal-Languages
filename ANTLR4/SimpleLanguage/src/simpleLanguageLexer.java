// $ANTLR 3.0 simpleLanguage.g 2009-03-19 17:39:48
...
public class simpleLanguageLexer extends Lexer {
    ...
    public final void mVAR() throws RecognitionException {
        try {
            int _type = VAR;
            // simpleLanguage.g:99:11: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // simpleLanguage.g:99:11: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // simpleLanguage.g:99:30: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            // simpleLanguage.g:100:11: ( '0' .. '9' | ( '1' .. '9' ) ( '0' .. '9' )+ )
            int alt3=2;
            ...
            if ( ((LA3_0>='1' && LA3_0<='9')) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("100:1: NUMBER : ( '0' .. '9' | ( '1' .. '9' ) ( '0' .. '9' )+ );", 3, 0, input);

                throw nvae;
            }
            switch (alt3) {
                case 1 :
                    // simpleLanguage.g:100:11: '0' .. '9'
                    {
                    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // simpleLanguage.g:100:22: ( '1' .. '9' ) ( '0' .. '9' )+
                    {
                    // simpleLanguage.g:100:22: ( '1' .. '9' )
                    // simpleLanguage.g:100:23: '1' .. '9'
                    {
                    matchRange('1','9'); 

                    }

                    // simpleLanguage.g:100:32: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            // simpleLanguage.g:102:11: ( '/*' (~ ( '*/' ) )+ '*/' )
            // simpleLanguage.g:102:11: '/*' (~ ( '*/' ) )+ '*/'
            {
            match("/*"); 

            // simpleLanguage.g:102:16: (~ ( '*/' ) )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
