...
public class grammatikParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "VAR", "TOKEN", "LITERAL", "MULTI_COMMENT", "LINE_COMMENT", "WS", "':'", "'|'", "';'"
    };
    ...
    public final Rule rule() throws RecognitionException {
        ...
        try {
            ...
            match(input,10,FOLLOW_10_in_rule78); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,11,FOLLOW_11_in_rule103); 
            ...
            match(input,12,FOLLOW_12_in_rule115); 
             regel = new Rule(new Variable((v!=null?v.getText():null)), bodyList); 
    ...
    public static final BitSet FOLLOW_VAR_in_rule76 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_10_in_rule78 = new BitSet(new long[]{0x0000000000001870L});
    public static final BitSet FOLLOW_body_in_rule84 = new BitSet(new long[]{0x0000000000001800L});
    public static final BitSet FOLLOW_11_in_rule103 = new BitSet(new long[]{0x0000000000001870L});
    public static final BitSet FOLLOW_body_in_rule109 = new BitSet(new long[]{0x0000000000001800L});
    public static final BitSet FOLLOW_12_in_rule115 = new BitSet(new long[]{0x0000000000000002L});
