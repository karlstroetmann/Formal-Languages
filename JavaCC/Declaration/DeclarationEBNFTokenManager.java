/* Generated By:JavaCC: Do not edit this line. DeclarationEBNFTokenManager.java */

public class DeclarationEBNFTokenManager implements DeclarationEBNFConstants
{
...
public DeclarationEBNFTokenManager(SimpleCharStream stream){
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public DeclarationEBNFTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
