/* Generated By:JavaCC: Do not edit this line. DeclarationParser2TokenManager.java */

public class DeclarationParser2TokenManager implements DeclarationParser2Constants
{
...
public DeclarationParser2TokenManager(SimpleCharStream stream){
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public DeclarationParser2TokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
